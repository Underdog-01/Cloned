...
function sportal_admin_block_edit()
{
	...
	if (!empty($_POST['preview_block']))
	{
		...
		elseif (strpos($context['widths'][1], 'px') !== false)
			$context['widths'][2] = ($context['widths'][3] = 960 - (preg_replace('/[^0-9]/', '', $context['widths'][1]) + preg_replace('/[^0-9]/', '', $context['widths'][4]))) . 'px';
	...
	<script language="JavaScript" type="text/javascript"><!-- // --><![CDATA[
		function sp_collapseObject(id)
		{
			...
			document.getElementById("sp_collapse_" + id).src = smf_default_theme_url + "/images/sp" + (mode ? "/collapse.' . $context['SPortal']['image_type'] . '" : "/expand.' . $context['SPortal']['image_type'] . '");
