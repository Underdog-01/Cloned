...
function template_block_default($block)
{
	...
	if ($block['type'] == 'sp_news' && !empty($modSettings['sp_bullets']) && strpos($block['style']['body']['class'], 'roundframe') === false)
		echo '
	<div class="sp_news_below sp_block_section', isset($context['SPortal']['sides'][$block['column']]['last']) && $context['SPortal']['sides'][$block['column']]['last'] == $block['id'] && ($block['column'] != 2 || empty($modSettings['articleactive'])) ? '_last' : '', '">';
	else
		echo '
	<div class="sp_block_section', isset($context['SPortal']['sides'][$block['column']]['last']) && $context['SPortal']['sides'][$block['column']]['last'] == $block['id'] && ($block['column'] != 2 || empty($modSettings['articleactive'])) ? '_last' : '', '">';
	...
	if ($block['type'] == 'sp_news')
		echo '
			<div', empty($block['style']['body']['class']) ? 'sp_news_body' : ' class="sp_news_body ' . $block['style']['body']['class'] . '"', ' style="margin-top: 0;">';
	else
		echo '
			<div', empty($block['style']['body']['class']) ? '' : ' class="' . $block['style']['body']['class'] . '"', ' style="margin-top: 0;">';

	if (empty($block['style']['no_body']) && strpos($block['style']['body']['class'], 'roundframe') === false)
	{
		echo '
	...
	elseif (strpos($block['style']['body']['class'], 'roundframe') !== false)
		echo '
